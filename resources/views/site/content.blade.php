                        ...
                        <div class="hero_section">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-sm-5">
                                    <img src="assets/img/{{$page->images}}" class="zoomIn wow animated" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="inner_wrapper">
                    <div class="container">
                        ...
                        <div class="inner_section">
                            <div class="row">
                                <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right"><img src="assets/img/{{$page->images}}" class="img-circle delay-03s animated wow zoomIn" alt=""></div>
        ...
        @endif
            ...
            <div class="isotope fadeInLeft animated wow" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper">
                    ...
                    <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   {{ $portfolio->filter }} isotope-item">
                        <div class="portfolio_img"> <img src="assets/img/{{ $portfolio->images }}"  alt="Portfolio 1"> </div>
        ...
        <div class="container">
            ...
            @foreach($peoples as $key => $team)
                    <div class="team_area">
                        ...
                        <h3 class="wow fadeInDown delay-0{{($key+1)*3}}s">{{ $team->name }}</h3>
                        <span class="wow fadeInDown delay-0{{($key+1)*3}}s">{{ $team->position }}</span>
                        <p class="wow fadeInDown delay-0{{($key+1)*3}}s">{{ $team->text }}</p>
                    </div>
            @endforeach
...
<footer class="footer_wrapper" id="contact">
    <div class="container">
        <section class="page_section contact" id="contacts">
